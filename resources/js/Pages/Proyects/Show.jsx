...
const Show = ({ auth, allProyects,userLikedProyects }) => {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Todos los Proyectos</h2>}
        >
                                            ...
                                            <div className="flex space-x-4">
                                                <button 
                                                    ...
                                                    className={`border font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center me-2 ${
                                                        likedProyects.includes(proyect.id) 
